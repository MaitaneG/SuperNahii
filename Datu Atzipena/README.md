...
Proiektua hainbat karpetetan banatuta dago:
  ...
  - **eus.dam.uni.dao:**: bertan DAO-a dago. [PuntuazioDAO-a](https://github.com/MaitaneG/SuperNahii/blob/main/Datu%20Atzipena/REST_API_SuperNaaahi/src/main/java/eus/dam/uni/dao/PuntuazioaDAO.java) datuak kudeatzen duenez, ***@Repository*** anotazioa jarri behar da. Datu guztiak gordetzen duen metodoari ***@PostConstruct*** bat jarri diogu. Bean-a sortu bezain laster datuak kargatzeko. Gainera MongoClient objektua autoinjektatu dugu ***@Autowired*** erabiliz 
  
  - **eus.dam.uni.model:** bertan puntuazioen pojoa dago. [Puntuazioa](https://github.com/MaitaneG/SuperNahii/blob/main/Datu%20Atzipena/REST_API_SuperNaaahi/src/main/java/eus/dam/uni/model/Puntuazioa.java) klasea hainbat atributu, getter eta setter, equals, hashcode, eta toString metodoak daude.
